...
# installed.
TCL_PREFIX='D:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/GENAI-2/Llamaindex/End-End _LLM_APP_Using_Llama_index/venv\Library\lib\tclstub86.lib'
